        ...
        <aside className="w-64 border-r border-[var(--border)] bg-[var(--surface)] hidden md:block">
          <div className="p-2">
            <nav className="flex flex-col gap-1">
              <a href="/dashboard" className="flex items-center gap-2 text-[13px] font-normal tracking-[-0.01em] px-2.5 py-[5px] rounded-[6px] text-[var(--muted)] hover:text-[var(--text)] hover:bg-[var(--border)] transition-colors">
              ...
              <a href="/dashboard/plants" className="flex items-center gap-2 text-[13px] font-normal tracking-[-0.01em] px-2.5 py-[5px] rounded-[6px] text-[var(--muted)] hover:text-[var(--text)] hover:bg-[var(--border)] transition-colors">
                <IconWrapper><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2v20M2 12h20" /></svg></IconWrapper>
                My Plants
              </a>
              <a href="/dashboard/weather" className="flex items-center gap-2 text-[13px] font-normal tracking-[-0.01em] px-2.5 py-[5px] rounded-[6px] text-[var(--muted)] hover:text-[var(--text)] hover:bg-[var(--border)] transition-colors">
              ...
              <a href="/dashboard/settings" className="flex items-center gap-2 text-[13px] font-normal tracking-[-0.01em] px-2.5 py-[5px] rounded-[6px] text-[var(--muted)] hover:text-[var(--text)] hover:bg-[var(--border)] transition-colors">
